...
//読み込みたい画像のパスの設定
Asset.assets = [
    { type: 'image', name: 'okiteru', src: 'notSleep.png' },
    { type: 'image', name: 'neteru', src: 'sleep.png' },
    { type: 'image', name: 'hukidasi', src: 'hukidasi.png' },
    { type: 'image', name: 'coal', src: 'sleep_coal.png' },
    { type: 'image', name: 'komaru', src: 'komaru.png' },
    { type: 'image', name: 'bg', src: 'bg.png' },
    { type: 'image', name: 'man', src: 'guruguru_man.png' },
    { type: 'image', name: 'car', src: 'car_black.png' },
    { type: 'image', name: 'post', src: 'yuubin_post.png' },
    { type: 'image', name: 'sake', src: 'K_haiboru.png' },
];
