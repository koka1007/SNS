 ...
 * Generated at: 2020-07-10 02:54:44 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<script type=\"text/javascript\">ctx.font = \"25px Arial\";</script>\r\n");
      ...
      out.write("\t\t\t\t\t\t\tvar heigth = (100*(count + 1) + 50);\r\n");
      out.write("\t\t\t\t\t\t\tctx.font = \"40px Arial\"\r\n");
      out.write("\t\t\t\t\t\t\tctx.strokeText(count+1,20,heigth);\r\n");
      out.write("\t\t\t\t\t\t\tctx.font = \"25px Arial\"\r\n");
      out.write("\t\t\t\t\t\t\tctx.strokeText(\"");
      out.print( rbean.getRname() );
      out.write("\",50,heigth-5);\r\n");
      out.write("\t\t\t\t\t\t\tctx.font = \"40px Arial\"\r\n");
      out.write("\t\t\t\t\t\t\tctx.strokeText( ");
      out.print( rbean.getScore() );
      out.write(" ,220,heigth);\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\tvar heigth = (55*(count + 1)-130);\r\n");
      out.write("\t\t\t\t\t\t\tctx.font = \"30px Arial\";\r\n");
      out.write("\t\t\t\t\t\t\tctx.strokeText(count+1,20+width,heigth);\r\n");
      out.write("\t\t\t\t\t\t\tctx.font = \"15px Arial\";\r\n");
      out.write("\t\t\t\t\t\t\tctx.strokeText(\"");
      out.print( rbean.getRname() );
      out.write("\",65+width,heigth-5);\r\n");
      out.write("\t\t\t\t\t\t\tctx.font = \"30px Arial\";\r\n");
      out.write("\t\t\t\t\t\t\tctx.strokeText( ");
      out.print( rbean.getScore() );
      out.write(" ,230+width,heigth);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t");
}
